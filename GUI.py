...
class Login_Interface:
    ...
    def left_frame_contents(self, leftFrame):
        ...
        self.photo_image = Image.open("default.png").convert("RGBA")
        ...
        self.login = tk.CTkButton(self.leftFrame, text="Log-in", width= 200, height= 50, font=("Poppins", 20), fg_color= "#2c2c2c", text_color= "#e1e1e1", corner_radius= 50)
        self.login.place(relx= 0.5, y = 380, anchor= "n")
        self.sign_up = tk.CTkButton(self.leftFrame, text="Sign-Up", width= 350, height= 70, font=("Poppins", 20), fg_color= "#2c2c2c", text_color="#e1e1e1", corner_radius= 50)
