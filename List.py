...
class List:
    ...
    def __table_needs(self):
        ...
        self.__table_display_needs = ttk.Treeview(self.__get_table_list_frame(), columns=('col1', 'col2'),show= 'headings', style="Needs.Treeview")
    ...
    def __table_wants(self):
        ...
        self.__table_display_wants = ttk.Treeview(self.__get_table_list_frame(), columns=('col3', 'col4'),show= 'headings', style="Wants.Treeview")
