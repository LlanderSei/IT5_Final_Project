...
class Registration_Interface:
    ...
    def create_registration_form(self):
        ...
        self.__first_name = ctk.CTkLabel(self.__get_left_frame(), text="First Name", fg_color="#696969", text_color="white", font=label_font)
        self.__first_name.place(relx=0.2, rely=0.10, anchor="center")
        self.__first_name_entry = ctk.CTkEntry(self.__get_left_frame(), font=label_font, width=entry_width, corner_radius=35, fg_color="#2c2c2c", height=50, text_color="white")
        self.__first_name_entry.place(x=150, y=40)  

        self.__last_name = ctk.CTkLabel(self.__get_left_frame(), text="Last Name", fg_color="#696969", text_color="white", font=label_font)
        self.__last_name.place(relx=0.2, rely=0.19, anchor="center")
        self.__last_name_entry = ctk.CTkEntry(self.__get_left_frame(), font=label_font, width=entry_width, corner_radius=35, fg_color="#2c2c2c", height=50, text_color="white")
        self.__last_name_entry.place(x=150, y=100)  

        self.__age = ctk.CTkLabel(self.__get_left_frame(), text="Age", fg_color="#696969", text_color="white", font=label_font).place(relx=0.2, rely=0.28, anchor="center")
        self.__age_entry = ctk.CTkEntry(self.__get_left_frame(), font=label_font, width=entry_width, corner_radius=35, fg_color="#2c2c2c", height=50, text_color="white")
        self.__age_entry.place(x=150, y=160)  

        self.__address = ctk.CTkLabel(self.__get_left_frame(), text="Address", fg_color="#696969", text_color="white", font=label_font)
        self.__address.place(relx=0.2, rely=0.37, anchor="center")
        self.__address_entry = ctk.CTkEntry(self.__get_left_frame(), font=label_font, width=entry_width, corner_radius=35, fg_color="#2c2c2c", height=50, text_color="white")
        self.__address_entry.place(x=150, y=220)  

        self.__reg_username = ctk.CTkLabel(self.__get_left_frame(), text="Username", fg_color="#696969", text_color="white", font=label_font)
        self.__reg_username.place(relx=0.2, rely=0.46, anchor="center")
        self.__reg_username_entry = ctk.CTkEntry(self.__get_left_frame(), font=label_font, width=entry_width, corner_radius=35, fg_color="#2c2c2c", height=50, text_color="white")
        self.__reg_username_entry.place(x=150, y=280)  

        self.__reg_password = ctk.CTkLabel(self.__get_left_frame(), text="Password", fg_color="#696969", text_color="white", font=label_font)
        self.__reg_password.place(relx=0.2, rely=0.56, anchor="center")
        self.__reg_password_entry = ctk.CTkEntry(self.__get_left_frame(), font=label_font, width=entry_width, corner_radius=35, fg_color="#2c2c2c", height=50, text_color="white")  
        self.__reg_password_entry .place(x=150, y=340)  

        self.__students = ctk.CTkLabel(self.__get_left_frame(), text="Student", fg_color="#696969", text_color="white", font=label_font)
        self.__students.place(relx=0.2, rely=0.65, anchor="center")
        self.__kids = ctk.CTkLabel(self.__get_left_frame(), text="Kids", fg_color="#696969", text_color="white", font=label_font)
        self.__kids.place(relx=0.2, rely=0.75, anchor="center")

        self.__students_checkbox_yes = ctk.CTkCheckBox(self.__get_left_frame(), text="Yes", variable=self.is_student, onvalue="Yes", 
        ...
        self.__students_checkbox_no = ctk.CTkCheckBox(self.__get_left_frame(), text="No", variable=self.is_student, onvalue="No", 
                offvalue="Yes", fg_color="#696969", text_color="white", 
                font=('Poppins', 25), height=50, width=30, border_width=2, corner_radius=0)
        self.__students_checkbox_no.place(x=250, y=400)  

        self.__kids_checkbox_yes = ctk.CTkCheckBox(self.__get_left_frame(), text="With", variable=self.has_kids, onvalue="With", 
        ...
        self.__kids_checkbox_no = ctk.CTkCheckBox(self.__get_left_frame(), text="Without", variable=self.has_kids, onvalue="Without", 
        ...
        self.__signup = ctk.CTkButton(self.__get_left_frame(), text="Sign-Up", fg_color="#2c2c2c", text_color="white", 
                      font=label_font, corner_radius=35, height=50, width=entry_width)
