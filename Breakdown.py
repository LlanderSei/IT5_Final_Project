...
class Breakdown:
    ...
    def __usernamebutton(self):
        ...
        self.__username_button = ctk.CTkButton(self.__get_navigation_frame(),image = self.__name_pht, text="Name",width= self.__username_button_width(), height= 50, font=("Poppins",20),fg_color="grey")
    ...
    def __listbutton(self):
        ...
        self.__list_button = ctk.CTkButton(self.__get_navigation_frame(), text="List",image = self.__list_pht, width= self.__list_button_width(), height= 50, font=("Poppins",20), fg_color="grey")
    ...
    def __breakdownbutton(self):
        ...
        self.__breakdown_button = ctk.CTkButton(self.__get_navigation_frame(), image = self.__breakdown_pht, text="breakdown",width= self.__breakdown_button_width(), height= 50, font=("Poppins",20), fg_color="#2c2c2c")
